...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // (measured after M106 S255 with M303 E0 S210 C8)
    ...
    #define DEFAULT_Kp_LIST {  63.53,  63.53 }
    #define DEFAULT_Ki_LIST {   7.75,   7.75 }
    #define DEFAULT_Kd_LIST { 130.10, 130.10 }
  #else
    #define DEFAULT_Kp 63.53
    #define DEFAULT_Ki 7.75
    #define DEFAULT_Kd 130.10
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 257.89
  #define DEFAULT_bedKi 49.19
  #define DEFAULT_bedKd 901.39
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 109.9 }
